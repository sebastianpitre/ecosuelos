function intro_calcular() {
    ...
    intro.setOptions({
            steps: [
                ...
                intro: 'Este es el formulario que debes diligenciar con la información de tu suelo<audio autoplay class="w-100 mt-3 " controls><source class="bg-success" src="../../assets/mp3/example.mp3" type="audio/mpeg"></audio>presiona Next para avanzar', step: 1 },
                { element: document.getElementById('intro2'),
                 intro: 'Estos campos con un color oscuro se llenan automáticamente luego de hacer el siguiente paso <audio autoplay class="w-100 mt-3" controls><source src="../../assets/mp3/example.mp3" type="audio/mpeg"></audio>presiona Next para avanzar', step: 2 },
